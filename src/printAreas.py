...
def getCatalog():
    ...
    for r in range(1, sheet.nrows):
        ...
        sizes=getSizes(sheet.cell(r,8).value)
        datarow.extend(sizes)                          
        datalist.append(datarow)
    insertScrapProducts(datalist)
def getDecoration():
    ...
    for r in range(1, sheet.nrows):
        ...
        for index in range(1,7):
            ...
            if globals()['ImprintAddInfo%s' % index]:
                print globals()['ImprintAddInfo%s' % index]
...
#         print data
#         csvHires.writerow(data)
#         
#         datarow=[]
#         for index in range(0,44):
#             print sheet.cell(r,index).value
#             datarow.insert(index,sheet.cell(r,index).value.encode("utf-8") if not (type(sheet.cell(r,index).value)== int or type(sheet.cell(r,index).value) == float) else sheet.cell(r,index).value)
        datalist.append(datarow)
    insertDecorations(datalist)
...
# 
# cm=2.54
# csvHires = csv.writer(open('C:/Users/carlos.espinosa/Documents/Workspace/docs/printAreasOutput.csv', 'wb'))
# with open('C:/Users/carlos.espinosa/Documents/Workspace/docs/printAreas.csv') as csvfile:
#     reader = csv.reader(csvfile)
#     for row in reader:
#         sku=row[0]
#         ImprintMethod1=row[2]
#         ImprintLocation1=row[3]
#         ImprintWidth1=row[4]
#         ImprintHeight1=row[5]
#         ImprintAddInfo1=row[6]
#         ImprintLogoPlacement1=row[7]
#         ImprintDiameter1=row[8]
#         ImprintMethod2=row[9]
#         ImprintLocation2=row[10]
#         ImprintWidth2=row[11]
#         ImprintHeight2=row[12]
#         ImprintAddInfo2=row[13]
#         ImprintLogoPlacement2=row[14]
#         ImprintDiameter2=row[15]
#         ImprintMethod3=row[16]
#         ImprintLocation3=row[17]
#         ImprintWidth3=row[18]
#         ImprintHeight3=row[19]
#         ImprintAddInfo3=row[20]
#         ImprintLogoPlacement3=row[21]
#         ImprintDiameter3=row[22]
#         ImprintMethod4=row[23]
#         ImprintLocation4=row[24]
#         ImprintWidth4=row[25]
#         ImprintHeight4=row[26]
#         ImprintAddInfo4=row[27]
#         ImprintLogoPlacement4=row[28]
#         ImprintDiameter4=row[29]
#         ImprintMethod5=row[30]
#         ImprintLocation5=row[31]
#         ImprintWidth5=row[32]
#         ImprintHeight5=row[33]
#         ImprintAddInfo5=row[34]
#         ImprintLogoPlacement5=row[35]
#         ImprintDiameter5=row[36]
#         ImprintMethod6=row[37]
#         ImprintLocation6=row[38]
#         ImprintWidth6=row[39]
#         ImprintHeight6=row[40]
#         ImprintAddInfo6=row[41]
#         ImprintLogoPlacement6=row[42]
#         ImprintDiameter6=row[43]
# #         data=[sku,ImprintMethod1,ImprintLocation1,ImprintWidth1,ImprintHeight1,ImprintAddInfo1,ImprintLogoPlacement1,ImprintDiameter1,ImprintMethod2,ImprintLocation2,ImprintWidth2,ImprintHeight2,ImprintAddInfo2,ImprintLogoPlacement2,ImprintDiameter2,ImprintMethod3,ImprintLocation3,ImprintWidth3,ImprintHeight3,ImprintAddInfo3,ImprintLogoPlacement3,ImprintDiameter3,ImprintMethod4,ImprintLocation4,ImprintWidth4,ImprintHeight4,ImprintAddInfo4,ImprintLogoPlacement4,ImprintDiameter4,ImprintMethod5,ImprintLocation5,ImprintWidth5,ImprintHeight5,ImprintAddInfo5,ImprintLogoPlacement5,ImprintDiameter5,ImprintMethod6,ImprintLocation6,ImprintWidth6,ImprintHeight6,ImprintAddInfo6,ImprintLogoPlacement6,ImprintDiameter6]
# #         print data  
# #         csvHires.writerow(data)     
#         for index in range(1,7):
#             if globals()['ImprintWidth%s' % index]:
